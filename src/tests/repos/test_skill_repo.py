...
def test_get_skills_by_age(skill_repository: SkillRepository):
    """
...
def test_get_skills_by_age_not_found(skill_repository: SkillRepository):
    """
...
def test_get_skill(skill_repository: SkillRepository):
    """
...
def test_get_skill_not_found(skill_repository: SkillRepository):
    """
...
def test_get_skills_list(skill_repository: SkillRepository):
    """
...
def test_get_skill_types(skill_repository: SkillRepository):
    """
